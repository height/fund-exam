/* 几个视图里反复出现的小块 */
/* 图标路径取自 Tabler Icons（MIT），24×24 网格、圆角线端，跟原有手绘的那几个能对齐。
...
const ICONS = {
  ...
  back: ['M15 6l-6 6l6 6'],
  calc: ['M4 3m0 2a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v14a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2z',
    'M8 7m0 1a1 1 0 0 1 1 -1h6a1 1 0 0 1 1 1v1a1 1 0 0 1 -1 1h-6a1 1 0 0 1 -1 -1z',
    'M8 14l0 .01', 'M12 14l0 .01', 'M16 14l0 .01',
    'M8 17l0 .01', 'M12 17l0 .01', 'M16 17l0 .01'],
  ...
  wrong: ['M9 14l-4 -4l4 -4', 'M5 10h11a4 4 0 1 1 0 8h-1'],
  map: ['M3 17a2 2 0 0 1 2 -2h2a2 2 0 0 1 2 2v2a2 2 0 0 1 -2 2h-2a2 2 0 0 1 -2 -2l0 -2', 'M15 17a2 2 0 0 1 2 -2h2a2 2 0 0 1 2 2v2a2 2 0 0 1 -2 2h-2a2 2 0 0 1 -2 -2l0 -2', 'M9 5a2 2 0 0 1 2 -2h2a2 2 0 0 1 2 2v2a2 2 0 0 1 -2 2h-2a2 2 0 0 1 -2 -2l0 -2', 'M6 15v-1a2 2 0 0 1 2 -2h8a2 2 0 0 1 2 2v1', 'M12 9l0 3'],
  ...
  left: ['M5 12l14 0', 'M5 12l4 4', 'M5 12l4 -4'],
  right: ['M5 12l14 0', 'M15 16l4 -4', 'M15 8l4 4'],
  ...
  list: ['M3.5 5.5l1.5 1.5l2.5 -2.5', 'M3.5 11.5l1.5 1.5l2.5 -2.5', 'M3.5 17.5l1.5 1.5l2.5 -2.5', 'M11 6l9 0', 'M11 12l9 0', 'M11 18l9 0'],
  timeline: ['M5 4v16', 'M9 7h11', 'M9 12h8', 'M9 17h6'],
  numbers: ['M10 3l-2 18', 'M16 3l-2 18', 'M4 9h16', 'M3 15h16'],
  done: ['M8.56 3.69a9 9 0 0 0 -2.92 1.95', 'M3.69 8.56a9 9 0 0 0 -.69 3.44', 'M3.69 15.44a9 9 0 0 0 1.95 2.92', 'M8.56 20.31a9 9 0 0 0 3.44 .69', 'M15.44 20.31a9 9 0 0 0 2.92 -1.95', 'M20.31 15.44a9 9 0 0 0 .69 -3.44', 'M20.31 8.56a9 9 0 0 0 -1.95 -2.92', 'M15.44 3.69a9 9 0 0 0 -3.44 -.69', 'M9 12l2 2l4 -4'],
}
