...
**面向基金从业资格考试的移动端题库，收录 1673 道带解析题目，并按官方教材目录分类。**

无需注册，不设会员功能。练习进度、错题和考试记录均保存在本地浏览器中。

### [在线使用](https://height.github.io/fund-exam/)
...
题库按照官方教材目录整理，覆盖科目一 8 章、科目二 18 章。
...
使用 Safari 或 Chrome 打开[在线地址](https://height.github.io/fund-exam/)，
